...
()=> // appRenderPost
{
    ...
    p > 0 && mainContext.fillText('A JS13K Game by Hai Yong',mainCanvas.width/2, 210);
    ...
    mainContext.fillText('鍏冲崱 ' + level + '      鐢熷懡 ' + playerLives + '      鏁屼汉 ' + enemiesCount, mainCanvas.width/2, mainCanvas.height-40);
